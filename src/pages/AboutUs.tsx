        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mb-16 py-12 rounded-3xl">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              RJ Sportz is your trusted at-home sports academy offering expert coaching across 15 sports and fitness disciplines for all ages and skill levels.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-br from-card to-secondary/30 rounded-3xl p-8 md:p-12">
              ...
              <div className="grid lg:grid-cols-2 gap-8 items-start">
                ...
                <div className="space-y-5">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    With a dream to make professional sports training accessible to all, he founded <span className="text-primary font-semibold">RJ Sportz</span>, bringing expert coaching across 15 sports and fitness disciplines right to your doorstep.
                  </p>
          ...
          <section className="text-center">
            <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-3xl p-12">
              ...
              <Button size="lg" className="px-8" onClick={() => navigate(`/get-started?source=${encodeURIComponent('Get Started')}`)}>
                Get Started Today
              </Button>
            </div>
          </section>
